...
@interface CEDashboardViewController : UIViewController <CEDashboardItemViewDelegate, UIScrollViewDelegate, CEDashboardReorderDelegate, CEBuildingsListControllerDelegate, CEBuildingMiniViewDelegate> {
